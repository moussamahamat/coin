...
contract('DicoinToken', function(accounts) {
    ...
    it('Initializes the contract with the correct values', function() {
        return DicoinToken.deployed().then(function(instance) {
            ...
            assert.equal(name, 'Dicoin Token', 'has the correct name');
            return tokenInstance.symbol();
        }).then(function(symbol) {
            assert.equal(symbol, 'Dicoin', 'has the correct symbol');
            return tokenInstance.standard();
        }).then(function(standard) {
            assert.equal(standard, 'Dicoin Token v1.0', 'has the correct standard');
        });
    })
