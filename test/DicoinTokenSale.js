...
contract('DicoinTokenSale', function(accounts) {
    var tokenInstance;
    ...
    it('Facilitates token buying', function() {
        return DicoinToken.deployed().then(function(instance) {
            ...
            return DicoinTokenSale.deployed();
    ...
    it('Ends token sale', function() {
        return DicoinToken.deployed().then(function(instance) {
            ...
            assert.equal(balance.toNumber(), 999990, 'returns all unsold dicoin tokens to admin');
